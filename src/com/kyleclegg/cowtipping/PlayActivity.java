...
//	    	}
	...
	private void setHighScores() {
		...
		if (count == 0) {
			 ...
			 Toast cowsTipped = Toast.makeText(this, count + " cows tipped!", Toast.LENGTH_SHORT);
			 cowsTipped.show();
			 Toast lessThanFourteenTipped = Toast.makeText(this, "Call the sheriff we have a champion here!", Toast.LENGTH_SHORT);
			 ...
			 Toast cowsTipped = Toast.makeText(this, count + " cows tipped!", Toast.LENGTH_SHORT);
			 cowsTipped.show();
			 Toast lessThanTwentyFourTipped = Toast.makeText(this, "A Tommy Boy esque performance", Toast.LENGTH_SHORT);
			 ...
			 Toast cowsTipped = Toast.makeText(this, count + " cows tipped!", Toast.LENGTH_SHORT);
			 cowsTipped.show();
			 Toast aLotTipped = Toast.makeText(this, "Did you cheat? O...M..G!!!!", Toast.LENGTH_SHORT);
			 aLotTipped.show();
		}
